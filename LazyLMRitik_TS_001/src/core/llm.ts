 ...
 */
function lazy(client: Anthropic, problem: string): LazyEvaluationClient {
    const state = new LazyState(problem);
    const llm: LLM = { client, model: "claude-3-5-sonnet@20240620" };
...
export { LazyState, LLM, LazyEvaluationClient, lazy, swaggerSpec, swaggerUi };